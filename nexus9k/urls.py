...
urlpatterns = [
    ...
    url(r'^questions', TemplateView.as_view(template_name='qa/questions.html'), name='questions'),
    url(r'^question', TemplateView.as_view(template_name='qa/question.html'), name='question'),
